...
%         SMLs_info_rawXY = read(ssds);
        ...
        for partnum = 1:size(centr_lowres_GFP_filt,1)
            ...
            if XRaw_Right > maxX/2/3*2 || XRaw_Left < maxX/2/3 || YRaw_Down > maxY/3*2 || YRaw_Up < maxY/3
...
%             end
        ...
        %             end
                ...
                OutDir_partnum = strcat(TopDir, matlaboutbase, 'image_output\GFP_2color_MiddleOnly\');
